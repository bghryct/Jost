...
* 💤 **SKIP** Font family at './source/vf' lacks a METADATA.pb file.
...
<details>
<summary><b>[132] jost[slnt,wght].ttf</b></summary>
<details>
...
* ℹ **INFO** Could not detect which version of ttfautohint was used in this font. It is typically specified as a comment in the font version entries of the 'name' table. Such font version strings are currently: ['Version 3.5'] [code: version-not-detected]
...
* ℹ **INFO** Version string is: "Version 3.5"
...
* ℹ **INFO** This font contains the following optional tables [loca, GPOS, GSUB, prep, DSIG, gasp]
...
* 🍞 **PASS** ./source/vf/jost[slnt,wght].ttf is named canonically.
...
* 🍞 **PASS** Name Table entry: Copyright field 'Copyright 2019 The Jost Project Authors (https://github.com/bghryct/Jost)' matches canonical pattern.
